...
var AddLeadComponent = /** @class */ (function () {
    ...
    AddLeadComponent.prototype.addLead = function () {
        ...
        var l = this.lead;
        if ((l.cityId == 0) || (l.locationId == 0) || (l.propTypeId == 0) || (l.propNumber == null) ||
...
var LeadsComponent = /** @class */ (function () {
    ...
    LeadsComponent.prototype.setLeads = function (leads) {
        if (this.auth.isCityManager() == 'yes') {
            ...
            var invs = this.inventories;
            var loc_1 = this.auth.getlocation();
            invs = invs.filter(function (inv) {
                return inv.cityId == loc_1;
            });
